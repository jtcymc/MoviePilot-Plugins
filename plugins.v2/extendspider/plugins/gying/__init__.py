...
class GyingKSpider(_ExtendSpiderBase):
    ...
    def to_login(self, browser: Chromium):
        ...
        tab.wait.ele_displayed("css:input[name='username']", timeout=20)
    ...
    def get_enclosure_by_down(self, browser: Chromium, down_urls: list) -> list:
        new_tab = browser.new_tab()
...
if __name__ == "__main__":
    lou = GyingKSpider({
        ...
        "spider_username": "jtcymchh@proton.me",
        "spider_password": "shaw1+1=@"
    })
    # 使用直接请求
